                    ...
                    <table class="table table-bordered table-striped mt-1">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center"><h6>{{$client->last_name}}</h6></td>
                                <td class="text-center"><h6>{{$client->document}}</h6></td>
                                <td class="text-center"><h6>{{$client->phone}}</h6></td>
                                <td class="text-center"><h6>{{$client->address}}</h6></td>
