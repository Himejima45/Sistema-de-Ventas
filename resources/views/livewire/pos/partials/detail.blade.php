                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="text-center table-th">
                                    ...
                                    <span>
                                        <img src="{{ asset('storage/products/' . $item->attributes[0]) }}" alt="imagen de producto" height="90" width="90" class="ronded">
                                    </span>      
                                    @endif
                                </td>
                                ...
                                <td>
                                    <!-- ARREGLAR AQUI -->
                                    <input type="number" id="r{{$item->name}}" wire:change="updateQty({{$item->id}}, $('#r' + {{$item->id}}).val() )"
