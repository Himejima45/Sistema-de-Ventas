                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="javascript:void(0)" wire:click="Edit({{$permiso->id}})" class="btn btn-primary mtmobile" title="Editar Registro">
                                      <i class="fas fa-edit"></i>
                                    </a>
                                    <a href="javascript:void(0)" onclick="Confirm({{$permiso->id}})" class="btn btn-danger mtmobile" title="Eliminar Registro">
