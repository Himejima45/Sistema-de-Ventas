                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="last_name" type="text"
                                        ...
                                        placeholder="Ej: Gómez" autofocus>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="document" type="text"
                                        ...
                                        placeholder="Ej: 12512102" autofocus>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="email" type="email"
                                        ...
                                        value="{{ old('email') }}" placeholder="Ej: micorreo@email.com" required
                                        autocomplete="email">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="phone" type="phone"
                                        ...
                                        value="{{ old('phone') }}" placeholder="Ej: 04125784159" required
                                        autocomplete="phone">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="password" type="password"
                                        ...
                                        required placeholder="Ej: ***********" autocomplete="new-password">
