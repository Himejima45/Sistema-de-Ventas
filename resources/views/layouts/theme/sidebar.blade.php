        ...
        <nav id="compactSidebar">
            ...
            <script>
                document.getElementById('sidebar-search-input').addEventListener('keyup', function () {
                    ...
                    const items = document.querySelectorAll('.menu-categories li:not(.no-filter)');
            ...
            <ul class="menu-categories" style="padding-bottom: 2.4rem">
                ...
                @if (auth()->user()->hasAnyRole(['Admin', 'Employee']))
                        ...
                        <a href="{{ url('providers') }}" class="menu-toggle" data-active="false">
                            <div class="base-menu">
                                <div class="base-icons">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                        fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                        stroke-linejoin="round" class="lucide lucide-book-user">
                    ...
                    <li class="active">
                        <a href="{{ url('logs') }}" class="menu-toggle" data-active="false">
                            <div class="base-menu">
                                <div class="base-icons">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                        fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                        stroke-linejoin="round" class="lucide lucide-file-clock">
