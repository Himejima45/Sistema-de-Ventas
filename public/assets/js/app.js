var App = (function () {
        ...
        onSidebarHover: function () {
            ...
            for (var i = 0; i < getMenu.length; i++) {
                getMenu[i].addEventListener("mouseenter", function () {
                    getHref =
                        this.querySelectorAll(".menu-toggle")[0].getAttribute(
                            "href"
                        );
    ...
    var colorPallet = {
            ...
            if (!$(Selector.getBody).hasClass("single-page")) {
                if ($(Selector.getBody).hasClass("dashboard-analytics")) {
                    ...
                    $("#minimal").on("click", function (event) {
                        ...
                        /* Act on the event */
                        $html =
                            '<link href="assets/css/dashboard/dash_1-minimal.css" rel="stylesheet" type="text/css" class="dashboard-analytics-minimal" />';
                    ...
                    $("#minimal").on("click", function (event) {
                        ...
                        $html =
                            '<link href="assets/css/dashboard/dash_2-minimal.css" rel="stylesheet" type="text/css" class="dashboard-sales-minimal" />';
                ...
                $("#minimal").on("click", function (event) {
                    ...
                    /* Act on the event */
                    $html =
                        '<link href="assets/css/structure-minimal.css" rel="stylesheet" type="text/css" class="structure-minimal" />';
        ...
        setColorPalletTimer: function () {
            if (
                $(Selector.getBody).hasClass("dashboard-analytics") ||
                $(Selector.getBody).hasClass("dashboard-sales") ||
                $(Selector.getBody).hasClass("starterkit")
            ) {
                setTimeout(function () {
